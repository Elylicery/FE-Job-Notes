...
![image-20210207000246402](D:\Users\Documents\[note]前端笔记\前端框架及项目面试.assets\image-20210207000246402.png)
...
![image-20201204105336830](D:\Users\Documents\[note]前端笔记\前端框架及项目面试.assets\image-20201204105336830.png)
...
##  3-11 vue动态组件是什么——:is="component-name"
...
* hash模式(默认)：使用URL hash值来作路由，如http://abc.com/#/user/10，支持所有浏览器。
* H5 history模式：需要HTML5 History API和server端配置结合，如http://abc.com/user/20，不支持低版本浏览器。
...
通过 `forward() back() go()`等实现跳转动作，`pushState replaceState`
...
<img src="D:\Users\Documents\[note]前端笔记\前端框架及项目面试.assets\image-20210207001528127.png" alt="image-20210207001528127" style="zoom:50%;" />

<img src="D:\Users\Documents\[note]前端笔记\前端框架及项目面试.assets\image-20210207001631359.png" alt="image-20210207001631359" style="zoom:80%;" />

...
## 3-8 vue如何自己实现v-model——自定义 v-model
...
## 3-9 vue组件更新之后如何获取最新DOM ——$nextTick
...
##  3-11 vue动态组件——:is="component-name"
...
<img src=".\前端框架及项目面试.assets\image-20210207001631359.png" alt="image-20210207001631359" style="zoom:80%;" />

**MVVM模型的关键**：View的变化会直接映射在ViewModel中，这个映射的过程不需要手动实现，而是MVVM框架来做。

## 4-3 Vue响应式原理机制（数据双向绑定）
...
### （二）监听data变化的核心API是什么 —— Object.defineProperty
